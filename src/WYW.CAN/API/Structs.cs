...
namespace WYW.CAN
{
    ...
    struct ZlgMessageFrame
    {
        ...
        /// <summary>
        /// device 帧的数据。由于CAN 规定了最大是8 个字节，所以这里预留了8 个字节的空间，
    ...
    struct ZlgBoardStatus
    {
        ...
        /// <summary>
        /// device 控制器错误警告限制寄存器值。默认为96。
        /// </summary>
        public byte RegisterEWLimit;
        /// <summary>
        /// device 控制器接收错误寄存器值。为0-127 时，为错误主动状态，为128-254 为错误被动状态，为255 时为总线关闭状态。
        /// </summary>
        public byte RegisterRECounter;
        /// <summary>
        /// device 控制器发送错误寄存器值。为0-127 时，为错误主动状态，为128-254 为错误被动状态，为255 时为总线关闭状态
        /// </summary>
    ...
    struct AdvMessageFrame1
    {
        ...
        public int Flag;
        /// <summary>
        /// device object number, used in Full device. 默认0
        /// </summary>
    ...
    struct AdvParameter
    {
        ...
        //    0         13      WriteLine Timeout,Unit:ms                   Read Timeout,Unit:ms
    ...
    struct AdvStatus
    {
        ...
        public uint status;                    //The status register (SR); device address 2.
        public uint error_warning_limit;       //The error warning limit register (EWLR); device address 13.
        public uint rx_errors;                 //The RX error counter register (RXERR); device address 14.
        public uint tx_errors;                 //The TX error counter register (TXERR); device address 15.
        public uint error_code;                //The error code capture register (ECC); device address 12.
        ...
        public uint type;                      //device controller type. 1, SJA1000; 0 other device.
        ...
        public uint writetimeout;              //WriteLine timeout 
    }
